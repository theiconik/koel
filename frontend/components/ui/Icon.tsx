...
const paths = {
  ...
  sparkle: (
    <>
      <path d="M12 3v3M12 18v3M4.5 7.5l2 1M17.5 15.5l2 1M19.5 7.5l-2 1M6.5 15.5l-2 1M3 12h3M18 12h3" />
      <circle cx="12" cy="12" r="3" />
    </>
  ),
  tag: (
    <>
      <path d="M20.59 13.41 11 22l-9-9V2h11l9 9a2 2 0 0 1-1.41 3.41z" />
...
export default function Icon({ name, size = 20, stroke = 1.75, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
