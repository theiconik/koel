...
export default function InsightsPage() {
  ...
  useEffect(() => {
    if (selected) {
      ...
      setMessages([
        {
          role: "assistant",
          text: `i've been listening to ${selected.responseCount} voices from "${selected.title}". what would you like to understand?`,
        },
      ]);
    }
  ...
  function handleSelect(id: string) {
    ...
    setMessages([
      {
        role: "assistant",
        text: `i've been listening to ${s.responseCount} voices from "${s.title}". what would you like to understand?`,
      },
    ]);
    setInput("");
  }
  ...
  async function handleSend() {
    ...
    setMessages((prev) => [...prev, { role: "assistant", text: ERROR_MSG }]);
    setSending(false);
  }
