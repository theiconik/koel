...
export const mockSurveys: Survey[] = [
  {
    ...
    questions: [
      {
        id: "q1",
        text: "tell me about the last time you set up a survey — what was the first thing that tripped you up?",
        order: 1,
        askedCount: 37,
        answeredCount: 36,
        avgFollowUps: 1.6,
      ...
      {
        id: "q2",
        text: "what were you hoping koel would do differently from what you've tried before?",
        order: 2,
        askedCount: 36,
        answeredCount: 31,
        avgFollowUps: 1.2,
  ...
  },
  {
    ...
    questions: [
      {
        id: "q1",
        text: "walk me through what you were thinking when you first saw our pricing page.",
        order: 1,
        askedCount: 12,
        answeredCount: 12,
        avgFollowUps: 1.4,
        topTag: "pricing clarity",
      },
      {
        id: "q2",
  ...
  },
  {
    ...
    questions: [
      {
        id: "q1",
        text: "what made you decide to stop using koel?",
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    questions: [
      {
        id: "q1",
        text: "what's the one thing we should build next?",
        order: 1,
        askedCount: 12,
        answeredCount: 12,
        avgFollowUps: 2.1,
        topTag: "product roadmap",
      },
      {
        id: "q2",
        text: "how has koel changed the way your team collects feedback?",
        order: 2,
        askedCount: 12,
        answeredCount: 11,
        avgFollowUps: 1.8,
